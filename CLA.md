# memsom Individual Contributor License Agreement

Thank you for your interest in contributing to memsom (the "Project"), maintained
by MattsomStudio (the "Maintainer").

This Contributor License Agreement ("Agreement") documents the rights granted by
contributors to the Maintainer. It is adapted from the Apache Software Foundation
Individual Contributor License Agreement v2.0, with an added relicensing grant
(Section 8) specific to this Project. By signing, You accept and agree to these
terms for Your present and future Contributions submitted to the Project. Except
for the license granted herein to the Maintainer and recipients of software
distributed by the Maintainer, You reserve all right, title, and interest in and
...
Maintainer for inclusion in, or documentation of, any of the products owned or
managed by the Project (the "Work"). For the purposes of this definition,
...
tracking systems that are managed by, or on behalf of, the Maintainer for the
...
## 8. Relicensing and Dual-Licensing Grant

You acknowledge and agree that the Maintainer may license the Work, including Your
Contributions, under one or more license terms of the Maintainer's choosing. This
expressly includes the right to distribute the Work, or any portion of it,
Your Contributions included, under:

  (a) the GNU Affero General Public License version 3 or any later version, and/or
  (b) any other license terms, including proprietary or commercial license terms,
      whether or not compatible with the AGPL.

This Section 8 grant is in addition to, and does not limit, the license granted in
Section 2. Its purpose is to permit the Maintainer to offer the Work under a
dual-licensing or open-core model. You will not be entitled to any compensation as
a result of any such relicensing.
...
By signing below (via the automated CLA process on a pull request), You agree to
the terms of this Agreement for Your present and future Contributions to the
Project.

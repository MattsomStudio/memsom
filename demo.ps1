# memdag demo crib — explain/revoke vertical slice (demo locked 2026-06-12)
...
#   - mid-take screwup => `python memdag.py seed --reset --offline` and restart the

"""memdag_policy — declarative capability policy for the Gate #3 broker.
...
memdag's core discipline of labelling by channel, never by content (memdag.py:6).
...
def is_consequential(policy, tool) -> bool:
    ...
    return required_floor(policy, tool) > memdag.RANK["external"]

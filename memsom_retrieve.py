...
import memsom_llm  # shared Ollama keep_alive() helper (VRAM hygiene)
...
def index_node(conn: sqlite3.Connection, nid: int) -> None:
    ...
    import memsom_embed  # lazy: cheap, stdlib-only at import
...
def retrieve_graph(
    ...
    """
    import memsom_relate  # local: avoid import cost when graph is unused
    migrate(conn)

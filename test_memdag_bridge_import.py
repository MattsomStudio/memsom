"""Tests for memdag_bridge_import — flat-file memory -> memdag nodes (Phase 1).

Run:  python -m unittest discover -s . -p test_memdag_bridge_import.py
"""
...
class TestImport(Base):
    ...
    def test_changed_file_tombstones_old_inserts_new(self):
        ...
        self.assertEqual(memdag.get_node(self.conn, old)["tombstoned"], 1)

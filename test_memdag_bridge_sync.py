"""Tests for memdag_bridge_sync — Mac<->PC changeset round-trip (Phase 4).

Run:  python -m unittest discover -s . -p test_memdag_bridge_sync.py
"""
...
import memdag
import memdag_bridge_sync as sync
...
class Base(unittest.TestCase):
    ...
    def add(self, conn, stem, channel="endorsed"):
        nid = memdag.insert_node(conn, f"content {stem}", channel,

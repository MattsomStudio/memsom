"""Tests for memdag_tombstone — the sanctioned flat-memory delete path.

Run:  python -m unittest discover -s . -p test_memdag_tombstone.py
"""
...
import memdag_tombstone as tomb
...
class TestCLI(Base):
    ...
    def test_cli_ok_exit_zero(self):
        ...
        self.conn = memdag.get_connection()                        # reopen for tearDown

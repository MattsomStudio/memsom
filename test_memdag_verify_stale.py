"""Tests for memdag_verify_stale — verification-age staleness.

Run:  python -m unittest discover -s . -p test_memdag_verify_stale.py
"""
...
import memdag_verify_stale as vs
...
class TestReconcile(Base):
    ...
    def test_does_not_clear_supersession_stale(self):
        ...
        memdag_stale.mark_stale_cascade(self.conn, nid, "source superseded by node 999")
        vs.recompute_verify_stale(self.conn, now=NOW)
